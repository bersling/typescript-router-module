...
describe('Simple CRUD Route Test', () => {
    ...
    it('should return the item', (done) => {
        tsmongo_1.dao.create({ 'hello': 'world' }, 'items', (dbResp) => {
    ...
    it('should return all items', (done) => {
        tsmongo_1.dao.create({ 'hello': 'world' }, 'items', (dbResp1) => {
            tsmongo_1.dao.create({ 'goodbye': 'world' }, 'items', (dbResp2) => {
    ...
    it('should be able to update', (done) => {
        ...
        tsmongo_1.dao.create(item, 'items', (dbResp) => {
